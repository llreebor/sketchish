"use strict";function burgerMenu(){var e=document.querySelector(".burger"),t=document.querySelector(".menu__list");e.addEventListener("click",(function(){t.classList.toggle("active"),e.classList.toggle("active-burger"),document.body.classList.toggle("active")}))}if(burgerMenu(),AOS.init({offset:120}),document.body.classList.contains("about__body")&&(gsap.registerPlugin(ScrollTrigger),gsap.to(".about__img",{scrollTrigger:{trugger:".about__img",scrub:!0,start:"top top",end:"center center"},y:-500})),document.body.classList.contains("contacts__body")){var textareaValidate=function(){textarea.value?label.classList.add("active"):label.classList.remove("active")},phoneValidate=function(){phoneInput.value?phoneLabel.classList.remove("active"):phoneLabel.classList.add("active")},urlValidate=function(){urlInput.value?urlLabel.classList.remove("active"):urlLabel.classList.add("active")},textarea=document.querySelector("#textarea"),label=document.querySelector("#label");textarea.oninput=textareaValidate;var phoneInput=document.querySelector("#phone1"),phoneLabel=document.querySelector("#phone2");phoneInput.onclick=phoneValidate;var urlInput=document.querySelector("#url1"),urlLabel=document.querySelector("#url2");urlInput.onclick=urlValidate;var selector=document.querySelector(".phone__input"),im=new Inputmask("+(99)-999-999-9999",{showMaskOnHover:!1});im.mask(selector)}if(document.body.classList.contains("body__main")){var swiper=new Swiper(".review__container",{loop:!0,pagination:{el:".swiper-pagination"},navigation:{nextEl:".next__arrow",prevEl:".prev__arrow"}}),tabs=function(e,t,i,a){var n=arguments.length>4&&void 0!==arguments[4]?arguments[4]:"flex",r=document.querySelector(e),o=document.querySelectorAll(t),s=document.querySelectorAll(i);function l(){s.forEach((function(e){e.style.display="none"})),o.forEach((function(e){e.classList.remove(a)}))}function c(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:0;s[e].style.display=n,o[e].classList.add(a)}l(),c(),r.addEventListener("click",(function(e){var i=e.target;(i.classList.contains(t.replace(/\./,""))||i.parentNode.classList.contains(t.replace(/\./,"")))&&o.forEach((function(e,t){i!=e&&i.parentNode!=e||(l(),c(t))}))}))};tabs(".technologies__tabs-header",".tab__head-item",".tab__content-item","active")}function fixedNav(){var e=document.querySelector("nav");window.scrollY>=500?e.classList.add("fixed__nav"):e.classList.remove("fixed__nav")}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _defineProperties(e,t){for(var i=0;i<t.length;i++){var a=t[i];a.enumerable=a.enumerable||!1,a.configurable=!0,"value"in a&&(a.writable=!0),Object.defineProperty(e,a.key,a)}}function _createClass(e,t,i){return t&&_defineProperties(e.prototype,t),i&&_defineProperties(e,i),e}window.addEventListener("scroll",fixedNav);var getTemplate=function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:[],t=arguments.length>1?arguments[1]:void 0,i=arguments.length>2?arguments[2]:void 0,a=null!=t?t:"placeholder не указан",n=e.map((function(e){var t="";return e.id===i&&(a=e.value,t="selected"),'\n            <li class="select__item '.concat(t,'" data-type="item" data-id="').concat(e.id,'">').concat(e.value,"</li>\n        ")}));return'\n        <input type="hidden" class="hidden__input">\n        <div class="select__backdrop" data-type="backdrop"></div>\n        <div class="select__input" data-type="input">\n            <span data-type="value">'.concat(a,'</span>\n            <img src="./img/down-arrow.svg" alt="arrow" data-type="arrow" class="select__arrow">\n        </div>\n        <div class="select__dropdown">\n            <ul class="select__list">\n                ').concat(n.join(""),"\n            </ul>\n        </div>\n    ")},Select=function(){function e(t,i){_classCallCheck(this,e),this.$el=document.querySelector(t),this.options=i,this.selectedId=i.selectedId,this.render(),this.setup()}return _createClass(e,[{key:"render",value:function(){var e=this.options,t=e.placeholder,i=e.data;this.$el.classList.add("select"),this.$el.innerHTML=getTemplate(i,t,this.selectedId)}},{key:"setup",value:function(){this.clickHandler=this.clickHandler.bind(this),this.$el.addEventListener("click",this.clickHandler),this.$arrow=this.$el.querySelector('[data-type="arrow"]'),this.$value=this.$el.querySelector('[data-type="value"]')}},{key:"clickHandler",value:function(e){var t=e.target.dataset.type;if("input"===t)this.toggle();else if("item"===t){var i=e.target.dataset.id;this.select(i)}else"backdrop"===t&&this.close()}},{key:"isOpen",get:function(){return this.$el.classList.contains("open")}},{key:"current",get:function(){var e=this;return this.options.data.find((function(t){return t.id===e.selectedId}))}},{key:"select",value:function(e){this.selectedId=e,this.$value.textContent=this.current.value,this.$el.querySelectorAll('[data-type="item"]').forEach((function(e){return e.classList.remove("selected")})),this.$el.querySelector('[data-id="'.concat(e,'"]')).classList.add("selected"),this.options.onSelect&&this.options.onSelect(this.current),this.close()}},{key:"toggle",value:function(){this.isOpen?this.close():this.open()}},{key:"open",value:function(){this.$el.classList.add("open"),this.$arrow.classList.add("open")}},{key:"close",value:function(){this.$el.classList.remove("open"),this.$arrow.classList.remove("open")}},{key:"destroy",value:function(){this.$el.removeEventListener("click",this.clickHandler),this.$el.innerHTML=""}}]),e}();function _typeof2(e){return(_typeof2="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e})(e)}
/*!
 * dist/inputmask.min
